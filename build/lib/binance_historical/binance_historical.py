...
class BinanceHistorical:
    ...
    def option_historical(
        ...
        *** EOHSummary data is available only upto 23-10-2023 in binance vision
        ...
        dates = self.__populate_date_list(start_date, end_date, True)
    ...
    def future_historical(
                        ...
                        data_type: Literal[
                                    ...
                                    "klines", "markPriceKlines", "premiumIndexKlines", "trades"]= "klines",
                        freq: Literal[
        ...
        dates = self.__populate_date_list(start_date, end_date, monthly_only= monthly_only)
